...
Here you can find the functions 'plot()' and 'milestone1()'.
...
def plot(polarization: bool):
    ...
    obtained from 'perturbations_kX.txt' or 'perturbations_kX_neutrinos.txt'
    (if neutrinos are included) files, where X denotes the 'k=0.X'.
    ...
    1. Prompts the user to specify if photon polarization and neutrinos are
       included.
    2. Reads data from 'perturbations_kX.txt' or 'perturbations_kX.txt' files.
    ...
    plt.plot(x, Phi_1+Psi_1, color='blue', ls='dashed',\
             label=r'$\Phi(k=0.1/\text{Mpc})+\Psi(k=0.1/\text{Mpc})$')
    plt.plot(x, Phi_01, label=r'$\Phi(k=0.01/\text{Mpc})$', color='orange')
    plt.plot(x, Phi_01+Psi_01, color='orange', ls='dashed',\
             label=r'$\Phi(k=0.01/\text{Mpc})+\Psi(k=0.01/\text{Mpc})$')
    plt.plot(x, Phi_001, label=r'$\Phi(k=0.001/\text{Mpc})$', color='green')
    plt.plot(x, Phi_001+Psi_001, color='green', ls='dashed',\
